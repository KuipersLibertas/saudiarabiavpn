                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
                    <div className="col-span-1 md:col-span-1">
                        ...
                        <div className="flex gap-3">
                            ...
                            <a
                                href="https://www.youtube.com/channel/UCqHClA4VrZfFORC5DFBmQWw"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="inline-flex items-center justify-center w-10 h-10 bg-white/10 hover:bg-white/20 rounded-full transition-colors"
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            ...
                            <li><Link href="/terms" className="hover:text-white/80 transition-colors">Terms & Conditions</Link></li>
                        </ul>
                    </div>
                </div>
